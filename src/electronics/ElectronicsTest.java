...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='FirstName']"), "Manju");
        sendTextToElement(By.xpath("//input[@id='LastName']"), "Thakur");
        ...
        sendTextToElement(By.xpath("//input[@id='Email']"), "mba123@gmail.com");
        sendTextToElement(By.xpath("//input[@id='Company']"), "Thakur.LTD");
        clickOnElement(By.xpath("//input[@id='Newsletter']"));
        sendTextToElement(By.xpath("//input[@id='Password']"), "Mv123456");
        sendTextToElement(By.xpath("//input[@id='ConfirmPassword']"), "Mv123456");
        ...
        sendTextToElement(By.xpath("//input[@id='Email']"), "mvt@gmail.com");
        sendTextToElement(By.xpath("//input[@id='Password']"),"Mv123456");
